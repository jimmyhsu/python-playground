...
class LinkedList(object):
    ...
    def __init__(self, iterable=None):
        ...
        Best case: Ω(1) list is initialized empty
    ...
    def as_list(self):
        ...
        Best case: Ω(1) list is empty or only 1 element
    ...
    def delete(self, item):
        ...
        Best case: Ω(1) item is at the head of list
